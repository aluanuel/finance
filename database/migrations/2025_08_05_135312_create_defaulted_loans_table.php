...
class CreateDefaultedLoansTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('defaulted_loans', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('loan_status')->default('Defaulted');
    ...
    {
        Schema::dropIfExists('defaulted_loans');
    }
}
