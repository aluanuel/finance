                          ...
                          <tbody>
                            ...
                            @foreach($apps as $app)
                              <tr>
                                ...
                                <td>{{ $app->telephone }}</td>
                                <td>
                                  <form action="/apply/process/{{$app->id}}" method="post">
                                    @csrf
                         ...
                         <tbody>
                            ...
                            @foreach($running as $run)
                              <tr>
                                ...
                                <td>{{ $run->telephone }}</td>
                                <td><a href="/apply/trans/{{$run->id}}"><button class="btn btn-outline-primary">Pay</button></a></td>
                              </tr>
                            <?php $i++;?>
                            @endforeach
                        </tbody>
                         ...
                         <tbody>
                            ...
                            @foreach($completed as $complete)
                              <tr>
                                ...
                                <td><a href="/apply/trans/{{$complete->id}}"><button class="btn btn-outline-primary">Return</button></a></td>
                                @else
                                <td></td>
                                @endif
                              </tr>
