                    ...
                    @foreach($loan as $loan)
                      <tr>
                        ...
                        @if($loan->loan_status == "Pending Assessment")
                          ...
                          <td><a href="" class="btn btn-xs btn-default" data-toggle="modal" data-target="#groupLoanApplication{{$loan->id}}">Assess</a></td>
                                ...
                                <div class="modal-body">
                                  ...
                                  <form action="/apply/grp/loan/assess/{{ $loan->id }}" method="post">
                                    ...
                                    <div class="row form-group">
                                      ...
                                      <!-- col-4 -->
                                      <div class="col-2">
                                        <label>Interest rate on defaulting</label>
                                        <input class="form-control" value="{{ $loan->interest_on_defaulting }}" readonly> 
                                      </div>
                                      <!-- col-2 -->
                                      <div class="col-2">
                          ...
                          <td><a href="" class="btn btn-xs btn-outline-primary" data-toggle="modal" data-target="#loan_repayment{{$loan->id}}">Repay</a></td>
                            <div class="modal fade" id="loan_repayment{{$loan->id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
                              <div class="modal-dialog modal-lg" role="document">
                                <div class="modal-content">
                                  <div class="modal-header">
                                    <h6 class="modal-title justify-content-center text-uppercase" id="exampleModalLongTitle"> Repaying loan {{ $loan->loan_number }} - <span class="badge bg-info">{{ $loan->loan_status }} up to {{ $loan->loan_end_date }}</span> </h6>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                      <span aria-hidden="true">&times;</span>
                                    </button>
                                  </div>
