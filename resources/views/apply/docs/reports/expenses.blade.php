...
<html>
	...
	<body>
		<div class="doc-header">
			...
			<h4 style="text-align: center; text-transform: uppercase;">Expenses report</h4>
				...
				<tbody>
					...
					@foreach($expense as $ex)
						<tr>
							...
							<td style="padding-right: 100px;">{{ $ex->payment_name }}</td>
							<td>{{ number_format($ex->payment_amount) }}</td>
							<td>{{ $ex->created_at }}</td>
						</tr>
						<?php $i++; ?>
					@endforeach
